...
\def\rhinohookforeground{
  \fill[red] (0,0.9) ellipse [x radius=0.6, y radius=0.75];
}
\def\pighookforeground{
  \draw[red] (0,0.83) ellipse [x radius=0.62, y radius=0.69];
}
...
%\def\tikzlings@names@clist{bee,coati}
%\def\tikzlings@names@clist{bee}
